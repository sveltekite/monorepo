...
export class SchemaParser {
  static parseYAML(yamlContent: string): Schema {
    ...
    for (const [entityName, entityDef] of Object.entries(rawSchema)) {
      ...
      for (const [fieldName, fieldDef] of Object.entries(entityDef as Record<string, any>)) {
  ...
  private static parseRelation(fieldName: string, fieldDef: string, entityName: string): RelationConfig {
